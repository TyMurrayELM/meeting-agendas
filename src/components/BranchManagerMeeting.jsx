                                ...
                                >
                                  ...
                                  <td className="px-4 py-2 align-top">
                                    <input
                                      ...
                                      placeholder="..."
                                      className="w-full px-4 py-2 bg-whitehover:bg-gray-50 focus:bg-white focus:border focus:rounded-md focus:outline-none align-top leading-normal"
                                    />
                                  </td>
                                  <td className="px-4 py-2 align-top">
                                    <select 
